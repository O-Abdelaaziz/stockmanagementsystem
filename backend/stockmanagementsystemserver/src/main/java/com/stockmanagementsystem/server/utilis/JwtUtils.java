package com.stockmanagementsystem.server.utilis;
...
public class JwtUtils {
    ...
    public String extractIdEntreprise(String token) {
        ...
        return claims.get("entreprise_id", String.class);
    }
    ...
    private String createToken(Map<String, Object> claims, ExtendedUser userDetails) {
        ...
        return Jwts.builder().setClaims(claims)
                ...
                .claim("entreprise_id", userDetails.getIdEntreprise().toString())
